...
const SocialIcons = {
  ...
  Instagram: () => (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.32 14.815 3.83 13.664 3.83 12.367s.49-2.448 1.297-3.323c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.807.875 1.297 2.026 1.297 3.323s-.49 2.448-1.297 3.323c-.875.807-2.026 1.297-3.323 1.297z" />
    </svg>
  ),
  LinkedIn: () => (
    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  ...
  const socialMedia = [
    ...
    { name: "WhatsApp", icon: SocialIcons.WhatsApp, url: "#" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mb-8">
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-white">AeronPay</h3>
                <p className="text-sm text-gray-400">Digital Payments</p>
              </div>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Innovative prepaid card solutions and secure financial services
              for Indian retailers and customers.
            </p>
        ...
        >
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            Never share your password, card number, expiry date, CVV, PIN, OTP,
            or other confidential information with anyone even if the person
            claims to be from AeronPay.
          </p>
        </motion.div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © 2025 AeronFly International Pvt. Ltd. All Rights Reserved.
            </p>
